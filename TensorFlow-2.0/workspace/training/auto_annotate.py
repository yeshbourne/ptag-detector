...
PATH_TO_CKPT = 'test/model/version-1/frozen_inference_graph.pb'
PATH_TO_LABELS = 'test/model/version-1/label_map.pbtxt'

TOTAL_IMAGES = 380 #Edit this number to the numbers of images you have.
...
TEST_IMAGE_PATHS = [ os.path.join('test/', '{}.jpeg'.format(i)) for i in range(1,TOTAL_IMAGES) ]
